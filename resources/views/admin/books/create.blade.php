                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div class="col-span-2">
                        ...
                        <input
                            ...
                            id="title" name="title" type="text" value="{{ old('title') }}" required placeholder="Enter book title">
                        @error('title')
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="author" name="author" type="text" value="{{ old('author') }}" required placeholder="Enter author name">
                        @error('author')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="publication_date" name="publication_date" type="date" value="{{ old('publication_date') }}">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="price" name="price" type="number" step="0.01" value="{{ old('price') }}" required placeholder="0.00">
                        @error('price')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="quantityStock" name="quantityStock" type="number" value="{{ old('quantityStock') }}" required placeholder="0">
                        @error('quantityStock')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <input
                            ...
                            id="publisher" name="publisher" type="text" value="{{ old('publisher') }}" required placeholder="Publisher name">
                        @error('publisher')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea
                            ...
                            id="description" name="description" rows="4" required placeholder="Book description">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
